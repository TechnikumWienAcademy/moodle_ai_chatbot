...
/**
 * Defines backup_openaichat_activity_task class
 *
...
require_once($CFG->dirroot . '/mod/openaichat/backup/moodle2/backup_openaichat_stepslib.php');
...
class backup_openaichat_activity_task extends backup_activity_task {
    ...
    /**
     * Defines a backup step to store the instance data in the openaichat.xml file
     */
    protected function define_my_steps() {
        $this->add_step(new backup_openaichat_activity_structure_step('openaichat_structure', 'openaichat.xml'));
    }
